...
export let player: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let ship_splitter: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let blast: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let firework: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let firework_splitter: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let asteroid_big: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let asteroid_medium: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let asteroid_small: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let asteroid_splitter: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
...
export let item_extralife: PossibleComponentDefs[] = [
	{
		type: "Position",
		x: 0,
		y: 0
